...
* **🔑 Clerk Authentication**: Secure, premium sign-in and sign-up powered by Clerk (with Google OAuth integration).
* **📊 Global Ladder Rating**: Sync and climb ranks. Your skill level updates in real-time on match completion.
* **💬 Player Reviews Slider**: Leave a rating and review in your profile, displayed dynamically on the main lobby slider.

---

## 🛠️ Monolithic Technology Stack
